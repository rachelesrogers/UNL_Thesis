...
They found that prosecutors interviewed supported the use of match terms such as “identification” and “individualization” instead of probabilistic terms, but two of the prosecutors also rejected the use of terms that convey “absolute certainty” (p. 7). 
...
\authorcol{The admissibility of expert testimony in the courtroom is also regulated by legal standards.
...
\authorcol{In 1975, the Federal Rule of Evidence 702 instead promoted "...mere 'assistance' to the trier of fact.." as the basis of admissibility, although whether} *Frye* \authorcol{or Rule 702 should be used for admissibility was not clarified until } *Daubert v. Merrell Dow Pharmaceuticals, Inc.*, \authorcol{which sided with Rule 702, with the added caveat that 'evidentiary reliability' should be established, although some states still use the *Frye* standard} [@nationalresearchcouncilusStrengtheningForensicScience2009, 89-91].
\authorcol{"The expert's testimony must be grounded in an accepted body of learning or experience in the expert's field, and the expert  must explain how the conclusion is so grounded"} [@nationalresearchcouncilusStrengtheningForensicScience2009, 94].
\authorcol{However, this standard of evidence often does not lead to inadmissible determinations, as demostrated in *United States v. Green*, where Judge Green stated that, while toolmark identification should not be admissible in terms of the *Daubert* ruling, it would be difficult to exclude due to precedent; he did, however, limit the examiner's conclusion language such that the examiner could not testify to a 'definitive match'} [@nationalresearchcouncilusStrengtheningForensicScience2009, 108].
