...
Some earlier researchers attempted to quantify the bullet matching process through the use of consecutively matching striae, but this process has yet to become standard.}
...
@nationalresearchcouncilusStrengtheningForensicScience2009 states that subjectivity is involved in determining “sufficient agreement” among firearms [155].
...
According to Todd Weller, consecutively matching striae is still used today by some examiners [@AuimatagiHearing, 98]. However, the use of consecutively matching striae has not been nationally adopted. 
