...
acknowledgments: |
  <!-- Thank you to my husband and partner, Richy Meleus. -->
  <!-- Thank you to my family. -->
  <!-- Thank you to my advisor, Dr. Susan VanderPlas. -->
  <!-- Thank you to my graduate school mentors, Drs. Emily Robinson, Alison Kleffner, Jessica Hauschild, and Kelsey Karnik. -->
  <!-- Thank you to my Master's program friends, Kory Heir and Eddie Gomez. -->
  <!-- Thank you to my supervisory committee. -->
  <!-- Thank you to my academic mentors. Drs. Kathy Hanford and Heike Hofmann. -->
  <!-- Thank you to my academic community at the Center for Statistics and Applications in Forensic Evidence. -->
...
For participants from the United States and Canada, 38 of 491 comparisons were reported as inconclusive for known matches, while 254 of 693 comparisons were reported as inconclusive for know non-matches [@chapnick2021].
<!-- [@chapnick2021, 6]. -->
...
According to @ommenProblemForensicScience2021, the usual form of "likelihood ratios" in forensic science are written as $\frac{P(E|H_p)}{P(E|H_d)}$, where E is the evidence, $H_p$ is the prosecution's hypothesis, and $H_d$ is the defense's hypothesis; however, there are the methods differ in how $P$ is calculated. 
<!-- (pp. 348 - 349). -->
