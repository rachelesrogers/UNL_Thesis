...
There are many different ways to measure participant responses, each of which may affect the accuracy with which the response reflects the construct that we wish to measure [@grovesSurveyMethodology2009].
