...
For example, @chapnick2021 does not include inconclusive results as an error. They reported three errors (false positives) in their study, and reported a false negative error rate of 0%, ignoring the wide range of inconclusive decisions.
