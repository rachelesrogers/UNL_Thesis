...
Striation marks are created on the bullet due to the rifling of the barrel, while the head of the cartridge casing is marked by the breech face.
...
Some issues outlined by @pcast are the circular nature of AFTE’s identification guidelines and the lack of appropriately designed error rate studies [104]. 
...
```{r signaturecompare, echo=FALSE, fig.cap="Left image depicts two matching signatures, while the right image depicts two non-matching signatures.", fig.align="center", fig.show="hold", out.width="49%"}
...
The issue of consistency in scale interpretation is also found in examiners.
