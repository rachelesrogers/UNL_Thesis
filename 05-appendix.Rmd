...
In order to clarify the speakers in the testimony and create a more engaging environment, we commissioned character drawings to represent various actors that may be present in the courtroom. These characters' faces and clothing are largely exchangeable, allowing for a large combination of clothing and characteristics.
