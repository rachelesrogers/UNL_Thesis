...
clean_results_merged$cat_prob <- NA
clean_results_merged[clean_results_merged$visible_probability==0,]$cat_prob <- "0%"
clean_results_merged[clean_results_merged$visible_probability==1,]$cat_prob <- "1%"
clean_results_merged[clean_results_merged$visible_probability>1 &
                      clean_results_merged$visible_probability<11 ,]$cat_prob <- "2% - 10%"
clean_results_merged[clean_results_merged$visible_probability>10 &
                      clean_results_merged$visible_probability<21 ,]$cat_prob <- "11% - 20%"
clean_results_merged[clean_results_merged$visible_probability>20 &
                      clean_results_merged$visible_probability<41 ,]$cat_prob <- "21% - 40%"
clean_results_merged[clean_results_merged$visible_probability>40 &
                      clean_results_merged$visible_probability<51 ,]$cat_prob <- "41% - 50%"
clean_results_merged[clean_results_merged$visible_probability>50 &
                      clean_results_merged$visible_probability<61 ,]$cat_prob <- "51% - 60%"
clean_results_merged[clean_results_merged$visible_probability>60 &
                      clean_results_merged$visible_probability<71 ,]$cat_prob <- "61% - 80%"
clean_results_merged[clean_results_merged$visible_probability>80 &
                      clean_results_merged$visible_probability<91 ,]$cat_prob <- "81% - 90%"
clean_results_merged[clean_results_merged$visible_probability>90 &
                      clean_results_merged$visible_probability<99 ,]$cat_prob <- "91% - 98%"
clean_results_merged[clean_results_merged$visible_probability==99,]$cat_prob <- "99%"
clean_results_merged[clean_results_merged$visible_probability==100,]$cat_prob <- "100%"

clean_results_merged$cat_prob <- 
  factor(clean_results_merged$cat_prob,
         levels = c("0%", "1%","2% - 10%", "11% - 20%", "21% - 40%",
                    "41% - 50%", "51% - 60%", "61% - 80%", "81% - 90%",
                    "91% - 98%", "99%", "100%"))
...
ggplot(subset(clean_results_merged, !is.na(cat_prob)), aes(x=cat_prob))+
  geom_bar()+
  facet_grid(chances_fixed~., labeller = labeller(chances_fixed = shortened_chance))+
  theme_bw()
