...
#| fig.scap= "Figures used in the response study.",
#| fig.width= 7,
#| fig.align= "center",
#| echo= FALSE,
#| message= FALSE,
...
However, there is not a significant difference between studies (Pearson's chi-squared p-value `r round(match_convict_compare$p.value, 2)`).
...
There is no significant difference between the hidden and visible probability scales, based on a paired t-test (p-value `r round(prob_compare$p.value, 2)`).
...
#| fig.scap= "Moasiac plot of participants who chose to express chance in terms of guilt or innocence, based on their opinion of the guilt of the defendant.",
#| fig.width= 6,
#| fig.height= 4,
#| fig.align= "center",
#| echo= FALSE,
