...
ggplot(subset(clean_results_merged, !is.na(visible_probability)), aes(x=visible_probability, y=chances_fixed))+
    geom_density_ridges(alpha=0.25, scale=1)+
  # facet_grid(chances_fixed~., labeller = labeller(chances_fixed = shortened_chance))+
  theme_bw()+
  geom_rect(aes(xmin=0, xmax=1, ymin=0, ymax=Inf), 
            fill="#648FFF", alpha=0.006) +
  geom_rect(aes(xmin=99, xmax=100, ymin=0, ymax=Inf), 
            fill="#648FFF", alpha=0.006) +
  geom_rect(aes(xmin=1, xmax=5.5, ymin=0, ymax=Inf), 
            fill="#785EF0", alpha=0.006)+
  geom_rect(aes(xmin=94.5, xmax=99, ymin=0, ymax=Inf), 
            fill="#785EF0", alpha=0.006)+
    geom_rect(aes(xmin=5.5, xmax=30, ymin=0, ymax=Inf), 
            fill="#DC267F", alpha=0.006)+
  geom_rect(aes(xmin=70, xmax=94.5, ymin=0, ymax=Inf), 
            fill="#DC267F", alpha=0.006)+
    geom_rect(aes(xmin=30, xmax=70, ymin=0, ymax=Inf), 
            fill="#FE6100", alpha=0.006)+
  geom_density_ridges(alpha=0, scale=1)+ 
...
The different colors indicate the closest multiple choice value to the selected probability.
