...
Of the `r dim(microstudy)[1]` participants, `r sum(microstudy$gender=="Man")` participants were men, `r sum(microstudy$gender=="Women")` participants were women, and `r sum(microstudy$gender=="Other/non-binary")` participants identified as other or non-binary. 
The median age category was `r median(microstudy$age)`.
...
There were `r sum(microstudy_clean$conclusion=="Match")` participants in the match condition, and `r sum(microstudy_clean$conclusion=="NoMatch")` participants in the elimination condition who passed the attention check.
...
`r round(sum(microstudy_clean$convict=="Yes" & microstudy_clean$conclusion=="Match")/sum(microstudy_clean$conclusion=="Match")*100, 2)`\% (or `r sum(microstudy_clean$convict=="Yes" & microstudy_clean$conclusion=="Match")` out of `r sum(microstudy_clean$conclusion=="Match")`) individuals who received the match condition chose to convict, while `r round(sum(microstudy_clean$convict=="Yes" & microstudy_clean$conclusion=="NoMatch")/sum(microstudy_clean$conclusion=="NoMatch")*100, 2)`\% (or `r sum(microstudy_clean$convict=="Yes" & microstudy_clean$conclusion=="NoMatch")` out of `r sum(microstudy_clean$conclusion=="NoMatch")`) participants who received the non-match condition chose to convict.
...
`r round(sum(microstudy_clean$guilt_opinion=="Yes" & microstudy_clean$conclusion=="Match")/sum(microstudy_clean$conclusion=="Match")*100, 2)`\% (or `r sum(microstudy_clean$guilt_opinion=="Yes" & microstudy_clean$conclusion=="Match")` out of `r sum(microstudy_clean$conclusion=="Match")`) individuals who received the match condition thought the defendant was guilty, while `r round(sum(microstudy_clean$convict=="Yes" & microstudy_clean$conclusion=="NoMatch")/sum(microstudy_clean$conclusion=="NoMatch")*100, 2)`\% (or `r sum(microstudy_clean$convict=="Yes" & microstudy_clean$conclusion=="NoMatch")` out of `r sum(microstudy_clean$conclusion=="NoMatch")`) participants who received the non-match condition thought the defendant was guilty.
...
\authorcol{Those who thought the defendant was innocent were more likely to favor inputting chance values in terms of innocence, while those who thought the defendant was guilty showed no clear preference.}
...
ggplot(microstudy_clean) +
  geom_density(alpha=0.75, aes(x=num_chance, fill=chance_of), position="dodge") +
...
ggplot(clean_results_merged, aes(x=chances_fixed))+ #,fill=conclusion
  ...
  geom_jitter(aes(y=(visible_probability/100)),
...
ggplot(microstudy_clean, aes(x=num_chance, color=conclusion, y=visible_probability)) +
  geom_jitter(alpha=0.5) +
  ggtitle("Probability vs Chance") +
  scale_color_manual(values = c("#037AC7","#FF8E00"), name="Conclusion")+
  ylab("Visible Probability")+
...
The correlation between the probabilities is `r round(cor(as.numeric(microstudy_clean$hidden_probability), microstudy_clean$visible_probability, use="complete.obs"),2)`, indicating a strong relationship.
...
ggplot(microstudy_clean, aes(x=betting, color=guilt_opinion, y=visible_probability)) +
  geom_jitter(alpha=0.75) +
