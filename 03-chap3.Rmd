...
In their study, @thompsonJurorsGiveAppropriate2013 compared the given chances that the defendant committed a crime to the decision to convict in their first experiment, and found a threshold of about 9 chances in 10, where participants who selected 9 chances in 10 or a higher chance amount were more likely to select a guilty verdict, while those below 9 chances in 10 were more likely to select a not guilty verdict.
