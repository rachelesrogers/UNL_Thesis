...
```{r}
#| likeprob,
#| fig.cap= "Probability and Likelihood Comparison",
#| fig.width= 10,
#| fig.height= 4,
#| fig.align= "center",
#| echo= FALSE,
...
ggplot(clean_results_merged, aes(x=fixed_like))+ #,fill=conclusion
  geom_point(aes(y=value),color="red",size=5,alpha=0.5)+
  ggtitle("Probability vs. Likelihood That Cole is Guilty") +
...
The correlation between the two responses is `r round(cor(microstudy_clean[!is.na(microstudy_clean$likelihood_rev),]$prob_vis, microstudy_clean[!is.na(microstudy_clean$likelihood_rev),]$likelihood_rev),2)`,
