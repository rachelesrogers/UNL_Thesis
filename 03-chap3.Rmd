...
ggplot(clean_results_merged)+
  geom_mosaic(aes(x=product(correct_range_word, chances_fixed),
...
Individuals who chose to express numeric chance in terms of innocence particularly struggled with the lower end of the chance scale (from "About 1 chance in 10,000" to "About 1 chance in 100").
...
Overall, participant selections appear to be fairly consistent between scales, with some individuals selecting less extreme values.
...
ggplot(clean_results_merged)+
  geom_mosaic(aes(x=product(prob_mult_consistency, chances_fixed),
                  fill=prob_mult_consistency))+
  theme_bw()+
  xlab("Impossible -> Certain")+
  scale_fill_manual(values = c("green" ,"grey"), name="Correct Range:")+
