...
\@ref(fig:completiontime) \authorcol{depicts completion times (from completion of the demographics information to the end of the survey) by conditions for unique fingerprints(n=560), excluding five observations greater than 75 minutes. In general, it appears that those who received the algorithm condition took slightly more time on average than those who did not (mean values of 22.61 minutes and 16.10 minutes, respectively). This is unsurprising, given the increased length of the algorithm condition.}
...
\authorcol{592} participants completed the survey, and \authorcol{570} participants correctly answered both attention check questions.
