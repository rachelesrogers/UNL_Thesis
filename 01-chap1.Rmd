...
Jurors' ability to interpret statistical methods and language is questionable; in a study conducted by @koehler2001 with regards to the probability of a random match in DNA evidence, they found that jurors had different interpretations wen the probability was presented as 1 out of 1,000 versus 0.1 out of 100, where those presented with a decimal number were more likely to view the probability of a random match as smaller. 
