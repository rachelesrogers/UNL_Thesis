...
```{r}
#| undertab,
#| tab.cap= "Table of understanding for the algorithm explanation",
#| tab.align= "center",
#| echo= FALSE,
#| message= FALSE,
#| warning= FALSE
kable(table(subset(algorithm_results,!is.na(algunder))$algunder,
      subset(algorithm_results,!is.na(algunder))$conclusion))
```
...
<!-- Do more research on jury selection -->
