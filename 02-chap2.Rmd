...
Page 1 | Page 2 | FNC Edit | FNC Page 2
       |        | Distance | Results
-------|--------|----------|------------
...
In order to create this effect, we first implemented a graph of the testimony in 'ggplot2' [@ggplot] in order to assign color values to the frequencies based on a continuous gradient.
