...
In Table \@ref(tab:fuzzymonth), "month.x" is the correctly spelled month, "month.y" is the child's spelling, and "dist" is the edit distance between the two words. 
