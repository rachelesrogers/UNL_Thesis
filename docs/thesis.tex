...
Hello there & there & \textbf{Hello} & deletion & 5 \\
...
\authorcol{In the dynamic programming approach, results are recorded in a table or matrix form, while the suffix tree approach organizes text into a tree format for performing calculations} (Keng, 2006).
...
This version of the thesis was generated on 2024-02-15 14:31:02.226046.
...
\leavevmode\vadjust pre{\hypertarget{ref-dynamicvstree}{}}%
Keng, L. H. (2006). \emph{Approximate string matching with dynamic programming and suffix trees} (Master's thesis). University of North Florida School of Computing.
