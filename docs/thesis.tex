...
\caption{Multiple Choice Likelihood}\label{fig:fixedlike}
\end{figure}
...
\caption{Free Response Likelihood}\label{fig:freelike}
\end{figure}
...
\caption{Free Response Likelihood, Log 10 Scale}\label{fig:freelike10}
\end{figure}

\hypertarget{scale-comparison}{%
\subsubsection{Scale Comparison}\label{scale-comparison}}

\hypertarget{likelihood-comparison}{%
\paragraph{Likelihood Comparison}\label{likelihood-comparison}}
...
\caption{Innocent Likelihood Comparison}\label{fig:likecomp1}
\end{figure}
...
\caption{Innocent Likelihood Comparison Log 10 Scale}\label{fig:likecomp1scale}
\end{figure}
...
\caption{Guilty Likelihood Comparison}\label{fig:likecomp2}
\end{figure}

Similar to the figures above, a comparison graph can be made to compare the multiple choice likelihood values to the probability scales.
This scale comparison is shown in Figure \ref{fig:likeprob}.
In the case of the probabilities, individuals were only able to select integers between 0 and 100, meaning that this scale would not translate to the more extreme values of the multiple choice likelihood scale (outside of the values of ``About 1 in 100'' and ``About 99 in 100'').
For values that can map from the probability scale to the likelihood scale, the values appear to be more spread out than those in the numerical likelihood scale, and those who selected ``About 1 chance in 10'' on the multiple choice scale tended to select larger likelihoods.
...
\caption{Probability and Likelihood Comparison}\label{fig:likeprob}
\end{figure}
...
\caption{Probability and Likelihood Comparison}\label{fig:likeprobcon}
\end{figure}

Figure \ref{fig:likeprobcon} shows a comparison of the perceived probability that the defendant committed the crime compared to the perceived likelihood that the defendant is guilty.
In the case of the match condition, it can be seen that many individuals assigned a high probability that the defendant committed the crime which corresponded to a high likelihood of guilt, as shown by the cluster of observations in the top right corner of the graph.
Similarly, in the non-match condition, many individuals gave a low probability that the individual committed the crime and a low likelihood that the defendant was guilty.
The correlation between the two responses is 0.87,
which indicates a fairly strong linear correspondence.
...
\caption{Probability and Likelihood Comparison}\label{fig:probcomp}
\end{figure}
...
This graph is similar to the comparison between likelihood and probability in that there is not an incredibly straightforward correspondence.
In both conditions, the bets are distributed throughout the graph, and correlation values can be calculated.
...
\caption{Probability and Likelihood Comparison}\label{fig:probbet}
\end{figure}
...
This version of the thesis was generated on 2023-08-21 16:13:47.
...
##    quanteda.textstats * 0.96.2  2023-04-27 [1] CRAN (R 4.3.1)
