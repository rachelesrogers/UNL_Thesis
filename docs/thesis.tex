...
\begin{longtable}[]{@{}
  >{\centering\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.4074}}
  >{\centering\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.4074}}
  >{\centering\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.0864}}
  >{\centering\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.0988}}@{}}
...
This version of the thesis was generated on 2024-02-21 14:23:14.603959.
