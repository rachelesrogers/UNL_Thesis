...
In order to perform fuzzy matching on the indirect collocations from participants' notes, I used `stringdist\_join' from the `fuzzyjoin' R package (Robinson).
...
This version of the thesis was generated on 2023-05-15 16:49:39.
...
##    fuzzyjoin          * 0.1.6      2020-05-15 [1] CRAN (R 4.2.3)
