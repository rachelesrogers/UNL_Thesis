...
In order to create a highlighting effect in the page notes, we first implemented a graph of the testimony in `ggplot2' (Wickham, 2016) in order to assign color values to the frequencies based on a continuous gradient.
...
\subsubsection{Validation Study}\label{validation-study}}
...
\hypertarget{first-n-character-fnc-method-1}{%
\paragraph{First n Character (FNC) Method}\label{first-n-character-fnc-method-1}}
...
\hypertarget{longest-common-substring-lcs-method-1}{%
\paragraph{Longest Common Substring (LCS) Method}\label{longest-common-substring-lcs-method-1}}
...
This version of the thesis was generated on 2024-03-04 11:26:55.827819.
