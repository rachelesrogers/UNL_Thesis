...
\begin{quote}
\authorcol{"Very difficult for juror to understand and remember the scientific evidence." - Identification, Algorithm, No Demonstrative Evidence}
\end{quote}
...
To glean some information from the original study, we designed a method for analyzing participant notes that were taken while reading through the testimony, to create a `heatmap' of areas of text that participants found to be important.
...
This version of the thesis was generated on 2024-03-11 13:12:07.330727.
