...
Of the 306 participants, 145 participants were men, 0 participants were women, and 5 participants identified as other or non-binary.
The median age category was NA.
...
299 participants passed the attention check, meaning that only NA participants failed the attention check, and will not be included in the analysis.
There were 147 participants in the match condition, and 152 participants in the elimination condition who passed the attention check.
...
54.42\% (or 80 out of 147) individuals who received the match condition chose to convict, while 4.61\% (or 7 out of 152) participants who received the non-match condition chose to convict.
...
74.15\% (or 109 out of 147) individuals who received the match condition thought the defendant was guilty, while 4.61\% (or 7 out of 152) participants who received the non-match condition thought the defendant was guilty.
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{table}\NormalTok{(microstudy\_clean}\SpecialCharTok{$}\NormalTok{chance\_of, microstudy\_clean}\SpecialCharTok{$}\NormalTok{guilt\_opinion)}
\end{Highlighting}
\end{Shaded}
...
This version of the thesis was generated on 2024-02-06 11:21:24.337061.
