...
\caption{Participant Note Example}\tabularnewline
\toprule\noalign{}
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.0988}}@{}}
\caption{Close Fuzzy Matches from the Testimony (continued below)}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
collocation.x
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
discharging a & charged with wilfully
discharging a & 1 & 1 \\
charged with willfully
discharging a & charged with willfully
disharging a & 1 & 1 \\
cole has been charged with & cole- has been charged with & 1 & 1 \\
discharging a firearm in a & discharing a firearm in a & 1 & 1 \\
the defendant richard cole has & he defendant richard cole has & 1 & 1 \\
in a place of business & in a place of business- & 1 & 1 \\
in a place of business & in a place of bussiness & 1 & 1 \\
in this case the defendant & n this case the defendant & 1 & 1 \\
richard cole has been charged & richard cole- has been charged & 1 & 1 \\
willfully discharging a
firearm in & wilfully discharging a firearm
in & 1 & 2 \\
\end{longtable}

\begin{longtable}[]{@{}
  >{\raggedright\arraybackslash}p{(\columnwidth - 0\tabcolsep) * \real{0.1806}}@{}}
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
close\_freq
\end{minipage} \\
...
\begin{longtable}[]{@{}
  ...
  >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.0864}}
  >{\raggedright\arraybackslash}p{(\columnwidth - 6\tabcolsep) * \real{0.0988}}@{}}
\caption{Distant Fuzzy Matches from the Testimony (continued below)}\tabularnewline
\toprule\noalign{}
\begin{minipage}[b]{\linewidth}\raggedright
collocation.x
\end{minipage} & \begin{minipage}[b]{\linewidth}\raggedright
...
\bottomrule\noalign{}
\endlastfoot
describes all of the evidence & information presentation and
demonstrative evidence & 32 & 1 \\
that was presented at trial & trial information presentation
and demonstrative & 30 & 1 \\
the evidence that was
presented & perception of trial
information presentation & 29 & 1 \\
evidence that was presented at & perception of trial
information presentation & 29 & 1 \\
describes all of the evidence & presentation and demonstrative
evidence study & 28 & 1 \\
\end{longtable}
...
This version of the thesis was generated on 2024-02-21 14:56:10.568717.
